...
class Sprint < Version
  ...
  scope :displayed_left, lambda { |project|
    joins(sanitize_sql_array([
      ...
      ") # next take only those versions which define 'display left' in their home project (or don't define anything)
      .where("(vs.display IS NULL OR vs.display = ?)", VersionSetting::DISPLAY_LEFT)
  }
